...
public class RankingTest {
  ...
  public void testRankingWithTFIDFAveragedWordEmbeddings() throws Exception {
    ...
    try {
      ...
      String pathname = "src/resources/enwiki-20180820-pages-articles14.xml-p7697599p7744799";
      ...
      try {
        ...
        WordVectorSerializer.writeWord2VecModel(vec, "target/w2v.zip");
        writer.deleteAll();
        writer.commit();
        writer.close();
        reader.close();
  ...
  public static void main(String[] args) {
	  ...
	  try {
	    t.testRankingWithDifferentSimilarities();
